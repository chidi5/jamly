...
export const deleteProduct = (store, id) => async (dispatch) => {
    try {
        dispatch({
...
export const listCategoryDetails = (store, id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://jamly2021.herokuapp.com/api/getcategoryproducts/${store}/${id}`)
...
export const deleteCategory = (store, id) => async (dispatch) => {
    try {
        dispatch({
        ...
        const { data } = await axios.get(
            `https://jamly2021.herokuapp.com/api/deletecategory/${store}/${id}`,
            config
        )
